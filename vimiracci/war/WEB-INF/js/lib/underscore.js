...
(function(module, exports) {
  ...
  _.reduceRight = _.foldr = function(obj, iterator, memo, context) {
    ...
    if (context && !initial)
      iterator = _.bind(iterator, context);
    return initial ? _.reduce(reversed, iterator, memo, context) : _.reduce(
        reversed, iterator);
  };
  ...
  _.max = function(obj, iterator, context) {
    ...
    each(obj, function(value, index, list) {
      var computed = iterator ? iterator.call(context, value, index, list)
          : value;
  ...
  _.memoize = function(func, hasher) {
    ...
    return function() {
      ...
      return hasOwnProperty.call(memo, key) ? memo[key] : (memo[key] = func
    ...
    if (className == '[object Array]') {
      ...
      for ( var key in a) {
        if (hasOwnProperty.call(a, key)) {
          ...
          if (!(result = hasOwnProperty.call(b, key)
  ...
  _.template = function(str, data) {
    ...
    var tmpl = 'var __p=[],print=function(){__p.push.apply(__p,arguments);};'
        ...
        + str.replace(/\\/g, '\\\\').replace(/'/g, "\\'").replace(
            c.escape || noMatch, function(match, code) {
...
}).call(this, window["module"], window["exports"]);
